...
import { getBranchList, getCollectionSummary } from '@/service/getdata'
...
export default function HeadwiseSummary() {
 ...
 //https://medium.com/readytowork-org/adding-a-header-footer-on-every-print-page-in-a-react-app-66ceccf9b35c
  ...
  const CallBranchData = async () => {
    ...
    const res = await getCollectionSummary({ branchid });
    ...
    <div>
      ...
      <div className="grid justify-items-center py-3">
        <div className="wrapper">
          Collection Head Wise Summary Report
                ...
                <div className="flex flex-col w-full bg-slate-200 rounded-md shadow-2xl">
                  ...
                  <div ref={contentToPrint}>
                    <div className="mt-1 flex flex-col text-left px-8">
                      ...
                      <h1 className="font-bold text-2xl">Category Wise Fee Collection Summary</h1>
                      ...
                      <table id="headerTable" className="table-fixed min-w-fit text-left text-sm font-light">
                        ...
                        <tbody className="border-b dark:border-neutral-500">

                          {
                            ...
                            cashledger.map((data, index) => {
                               { balance += Number(data.grosstotal) }
                              return <tr className="border-b dark:border-neutral-500" key={index}>
                                ...
                                <td className="text-nowrap px-3 py-2">{data.category }</td>
                                <td className="ml-50 text-right font-bold text-blue-800">{formatNumber(data.grosstotal)}</td>
                        ...
                        <tfoot>
                            <tr>
                              <td colSpan="2" className="text-right font-bold text-blue-800"></td>
                              <td className="text-right font-bold text-blue-800">==============</td>
                            </tr>                            
                            <tr>
                              <td colSpan="2" className="text-right font-bold text-blue-800">Total Amount Collected:</td>
                              <td className="text-right font-bold text-blue-800">{formatNumber(balance)}</td>
                            </tr>
                            <tr>
                              <td colSpan="2" className="text-right font-bold text-blue-800"></td>
                              <td className="text-right font-bold text-blue-800">==============</td>
